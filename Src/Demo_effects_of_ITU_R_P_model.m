% Propose: Demo effects of ITU.R.P 1546
% Author: Kevin
% Date: April 2nd, 2017

addpath('D:\\Code\\WorkSpace\\SpectrumModel\\Tools\\itu_pr1546');
% points=[Lon,Lat];
% len=60;
...
legend('接收天线高 h = 20m','接收天线高 h = 15m','接收天线高 h = 5m','接收天线高 h = 1m');
...
path='D:/doc/PapaerLibrary/Figures/Draft_6_figs/itu_1546';
