% Propose: generate random field with grid
% Author: Kevin
% Date: March 29th, 2017

function [X,Y,Z]=Generate_random_field(grids)
  %exception handle  
   if(nargin<1)
  ...
  grids=ceil(grids); range=1;
  x = linspace(0,range,grids);
